...
> Scope: BackendRuntime / RunPlan current-state audit
...
This audit compares the current repository with `docs/design/backend-runtime-runplan-docker.md`.
...
```text
R  docs/lightai-backend-runtime-runplan-docker-design.md -> docs/design/backend-runtime-runplan-docker.md
```
