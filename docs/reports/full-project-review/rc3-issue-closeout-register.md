...
| REVIEW-023 | Medium | **Not Reproducible** — E2E validation via api-only E2E (e2e-model-runtime-api.sh) passes; Docker available, NVIDIA GPU available | — |
...
| Status | Count | IDs |
|--------|-------|-----|
| Fixed | 27 | REVIEW-001-015,017,020-022,024-030 |
