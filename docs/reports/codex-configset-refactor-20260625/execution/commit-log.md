...
| E | Pending terminal report | `refactor: migrate api ui to configsets` | Pending terminal report | Public API/OpenAPI, Web pages/tests, and active scripts migrated to ConfigSet/current deployment contracts; stale legacy-contract scripts archived or removed from active paths. |
