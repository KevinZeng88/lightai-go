...
AGENT_METRICS_URL="${LIGHTAI_AGENT_METRICS_URL:-http://127.0.0.1:9091/metrics}"
PROM_URL="${LIGHTAI_PROMETHEUS_URL:-http://127.0.0.1:9090}"
GRAF_URL="${LIGHTAI_GRAFANA_URL:-http://127.0.0.1:3000}"
