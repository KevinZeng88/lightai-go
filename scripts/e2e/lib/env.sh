...
# E2E password variables — LIGHTAI_BOOTSTRAP_INITIAL_PASSWORD is canonical for clean-DB startup;
# LIGHTAI_BOOTSTRAP_ADMIN_PASSWORD is used for subsequent logins after bootstrap changes the password.
# Fall back: both default to LIGHTAI_E2E_PASSWORD for backwards compatibility.
LIGHTAI_BOOTSTRAP_INITIAL_PASSWORD="${LIGHTAI_BOOTSTRAP_INITIAL_PASSWORD:-${LIGHTAI_BOOTSTRAP_ADMIN_PASSWORD:-$LIGHTAI_E2E_PASSWORD}}"
LIGHTAI_BOOTSTRAP_ADMIN_PASSWORD="${LIGHTAI_BOOTSTRAP_ADMIN_PASSWORD:-${LIGHTAI_BOOTSTRAP_INITIAL_PASSWORD:-$LIGHTAI_E2E_PASSWORD}}"
