export default {
  ...
  startWizard: {title:"启动实例",selectModel:"选择模型",selectBackend:"选择后端",selectVersion:"选择版本",selectRuntime:"选择运行配置",preflight:"启动前检查",selectNode:"选择节点",gpuConfig:"GPU 配置",portConfig:"端口配置",commandPreview:"命令预览",start:"启动"},
  runnerConfigs: {title:"运行配置",name:"名称",template:"模板",runnerType:"运行方式",nodeCount:"节点数",readyCount:"就绪",actions:"操作",newConfig:"新增运行配置",selectTemplate:"选择模板",selectRunnerType:"选择运行方式",selectNode:"选择节点",selectImage:"选择镜像",configName:"配置名称",check:"检测",create:"创建",created:"运行配置已创建",runnerTypeDocker:"Docker",wizardTitle:"新增运行配置"},
}
